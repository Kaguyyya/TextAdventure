...
public class Earphones extends Item {

    public String serialNumber;

    public Earphones(String name, String serialNumber,String description) {
    ...
    public void performItemAction(int i) {
        switch (i){
            ...
            case 1:
                main.player.setConfidence(true);
               main.player.removeItemToInv(main.player.currentInventarInteraction);
                System.out.println(ConsoleColors.CYAN_UNDERLINED+"Ich fühle mich jetzt viel sicherer"+ConsoleColors.RESET);
                break;
            case 10:
